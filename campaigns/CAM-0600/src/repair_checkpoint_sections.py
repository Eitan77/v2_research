...
for i,row in frame.iterrows():
 plan=yaml.safe_load((CAM/row.campaign_id/"PLAN.yaml").read_text(encoding="utf-8")); frame.loc[i,"strategy_section"]=plan.get("paper_section"); frame.loc[i,"strategy_title"]=plan.get("title")
