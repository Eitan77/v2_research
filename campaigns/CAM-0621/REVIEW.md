...
Prior strategy evidence is invalid because the inherited stock panel adjusted forward splits in the wrong direction. The repaired structured result is **provisional_execution_survivor** using `etf__ibs30__top5__hold3__trend1`. Its full repaired 2 bp additive return is 153.6% with 14.0% maximum drawdown; 09:40 SIP replay at +2 bp is 27.7% with 4.9% drawdown and 7/5 positive/negative months. This remains adapted development evidence; the May 2026 holdout was not accessed and promotion is blocked.
